...
public class ConfigGUI_Editor extends GuiScreen {
    ...
    public void onGuiClosed() {
        ...
        if (StringHandler.isNullOrEmpty(specificMessage.getText()) || specificMessage.getText().equalsIgnoreCase(defaultMSG)) {
            ...
            CraftPresence.CONFIG.rebootOnWorldLoad = true;
            if (parentscreen instanceof ConfigGUI_BiomeSettings) {
                CraftPresence.CONFIG.biomeMessages = StringHandler.removeFromArray(CraftPresence.CONFIG.biomeMessages, selecteditem + CraftPresence.CONFIG.splitCharacter + specificMessage.getText());
            }
            if (parentscreen instanceof ConfigGUI_DimensionSettings) {
                CraftPresence.CONFIG.dimensionMessages = StringHandler.removeFromArray(CraftPresence.CONFIG.dimensionMessages, selecteditem + CraftPresence.CONFIG.splitCharacter + specificMessage.getText());
            }
        }
    }
}
